...
export const PROBE_SBX_CHANNEL = "desktop:probe-sbx";
export const INSTALL_SBX_CHANNEL = "desktop:install-sbx";
export const CREATE_SBX_SANDBOX_CHANNEL = "desktop:create-sbx-sandbox";
export const REMOVE_SBX_SANDBOX_CHANNEL = "desktop:remove-sbx-sandbox";
